...
public class Utils {
    ...
    public static String[] manufactureList = new String[] {
            "LG", "Sony", "Lenovo", "Samsung"
    };

    // получить отформатированную дату
    public static String getFormatDate(Date date) {
        return String.format("%1$td.%1$tm.%1$tY", date);
//        return new SimpleDateFormat("dd.MM.yyyy").format(date.getDate());
    }
    
    // парсинг даты из формы
    public static Date parseFormDate(String date) throws ParseException {
