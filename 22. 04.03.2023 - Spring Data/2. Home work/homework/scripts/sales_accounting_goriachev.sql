...
CREATE TABLE `persons` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `ck_persons_passport` (`passport`)
...
CREATE TABLE `purchases` (
  ...
  `amount` int NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_purchases_goods` (`id_goods`),
  KEY `fk_purchases_units` (`id_unit`),
  CONSTRAINT `fk_purchases_goods` FOREIGN KEY (`id_goods`) REFERENCES `goods` (`id`),
  CONSTRAINT `fk_purchases_units` FOREIGN KEY (`id_unit`) REFERENCES `units` (`id`),
...
CREATE TABLE `sales` (
  ...
  `amount` int NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_sales_purchases` (`id_purchase`),
  KEY `fk_sales_units` (`id_unit`),
  KEY `fk_sales_sellers` (`id_seller`),
  CONSTRAINT `fk_sales_purchases` FOREIGN KEY (`id_purchase`) REFERENCES `purchases` (`id`),
  CONSTRAINT `fk_sales_sellers` FOREIGN KEY (`id_seller`) REFERENCES `sellers` (`id`),
  CONSTRAINT `fk_sales_units` FOREIGN KEY (`id_unit`) REFERENCES `units` (`id`),
...
INSERT INTO `sales` VALUES (1,1,1,1,'2022-10-02',1900,2),(2,1,1,2,'2022-10-02',1950,3),(3,2,1,5,'2022-10-02',1960,2),(4,3,1,3,'2022-10-03',1900,6),(5,3,1,2,'2022-10-03',1950,5),(6,4,1,3,'2022-10-04',9000,3),(7,4,1,1,'2022-10-04',9300,2),(8,4,1,2,'2022-10-04',9200,1),(9,5,9,3,'2022-10-05',2500,2),(10,5,9,5,'2022-10-05',2600,1),(11,6,9,4,'2022-10-05',2300,1),(12,7,1,5,'2022-10-05',500,1),(13,8,1,4,'2022-10-07',8300,6),(14,6,9,3,'2022-10-07',2500,2),(15,7,1,6,'2022-10-07',500,8),(16,9,9,5,'2022-10-09',4300,2),(17,8,1,1,'2022-10-09',8300,4),(18,11,1,2,'2022-10-09',9000,3),(19,10,1,3,'2022-10-10',500,20),(20,11,1,4,'2022-10-10',9000,1),(21,10,1,3,'2022-10-11',450,8),(22,11,1,2,'2022-10-12',9000,1),(23,10,1,1,'2022-10-13',510,3),(24,10,1,4,'2022-10-15',560,1),(25,10,1,6,'2022-10-16',480,6),(26,15,9,5,'2022-10-17',100000,1),(27,12,4,3,'2022-10-17',40000,1),(28,13,1,6,'2022-10-17',600,20),(29,12,4,5,'2022-10-18',43000,1),(30,15,9,1,'2022-10-18',110000,1),(31,13,1,2,'2022-10-20',580,30),(32,14,4,3,'2022-10-20',25500,1),(33,14,4,1,'2022-10-21',27000,1),(34,12,4,3,'2022-10-23',45000,1),(35,13,1,2,'2022-10-25',650,10),(36,18,1,2,'2022-10-27',500,200),(37,19,10,5,'2022-10-27',1600000,1),(38,16,1,4,'2022-10-27',60,100),(39,17,4,2,'2022-10-28',16000,1),(40,18,1,5,'2022-10-29',660,100),(41,16,1,4,'2022-10-30',60,100),(42,17,4,3,'2022-10-30',16000,1),(43,17,4,2,'2022-10-30',16800,1),(44,18,1,6,'2022-10-31',580,200),(45,18,1,1,'2022-10-31',680,100),(46,21,7,6,'2022-11-02',80000,1),(47,20,1,5,'2022-11-03',380,2),(48,21,7,4,'2022-11-04',82000,1),(49,20,1,3,'2022-11-05',360,12),(50,21,7,4,'2022-11-06',80000,1),(51,20,1,3,'2022-11-07',380,6),(52,23,1,3,'2022-11-07',6600,3),(53,22,1,4,'2022-11-08',650,10),(54,23,1,5,'2022-11-08',6800,4),(55,22,1,5,'2022-11-08',600,15),(56,22,1,4,'2022-11-09',650,5),(57,23,1,3,'2022-11-09',6600,3);
...
CREATE TABLE `sellers` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_sellers_persons` (`id_person`),
  CONSTRAINT `fk_sellers_persons` FOREIGN KEY (`id_person`) REFERENCES `persons` (`id`),
...
-- Dump completed on 2023-03-06  2:01:27
