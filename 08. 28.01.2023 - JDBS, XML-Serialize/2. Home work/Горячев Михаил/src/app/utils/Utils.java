...
public class Utils {
    ...
    public static String[] cities = {
            "Киев", "Харьков", "Кривой Рог", "Одесса", "Донецк", "Львов", "Симферополь", "Херсон", "Днепр", "Покровск"
    };

    // список профессий
    public static String[] professions = {
            "бухгалтер", "программист", "электрик", "системный администратор", "повар", "сварщик", "механик",
            "конструктор", "архитектор", "учитель"
    };
