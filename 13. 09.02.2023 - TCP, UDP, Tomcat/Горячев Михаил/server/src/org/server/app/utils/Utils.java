...
public class Utils {
    ...
    // получить строку с текущим временем для сервера
    public static String getTime() {
        return Colors.YELLOW_BOLD_BRIGHT + "[" + LocalDateTime.now().format(DateTimeFormatter.ofPattern("HH:mm:ss")) + "] " + Colors.RESET;
    }
}
