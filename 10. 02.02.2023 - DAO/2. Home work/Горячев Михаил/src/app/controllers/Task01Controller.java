...
import app.middleware.PolyclinicDb;
import app.models.dao.entitiesDaoImpl.AppointmentDaoImpl;
import app.models.dao.entitiesDaoImpl.DoctorDaoImpl;
import app.models.dao.entitiesDaoImpl.PatientDaoImpl;
...
public class Task01Controller implements IController {
    ...
    public void dataMenu() {
        ...
        while (true) {
            try {
                select = Utils.showWindow("<html><h1 align='center'>Задание 1. Поликлиника > Данные</h1>", title, buttons, initialValue, imageIcon);
    ...
    public void queriesMenu() {
        ...
        while (true) {
            try {
                select = Utils.showWindow("<html><h1 align='center'>Задание 1. Поликлиника > Запросы</h1>", title, buttons, initialValue, imageIcon);
    ...
    public void crudMenu() {
        ...
        var initialValue = "Выход";
        var imageIcon = new ImageIcon();
        var title = "Задание 1. Поликлиника > CRUD";
        ...
        while (true) {
            try {
                select = Utils.showWindow("<html><h1 align='center'>Задание 1. Поликлиника > CRUD</h1>", title, buttons, initialValue, imageIcon);
